...
const NewChatNotificationEmail = ({ name, email, phone, message }: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Nova mensagem no chat de {name || 'visitante'}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>💬 Nova Mensagem no Chat</Heading>
        <Text style={text}>Um visitante enviou uma mensagem pelo chat do site.</Text>
...
export const template = {
  component: NewChatNotificationEmail,
  subject: (data: Record<string, any>) => `Nova mensagem no chat: ${data.name || 'Visitante'}`,
  to: 'felipfita@gmail.com',
  displayName: 'Notificação de chat',
  previewData: { name: 'Maria Santos', email: 'maria@email.com', phone: '(21) 98888-8888', message: 'Tenho interesse em imóveis no Recreio.' },
